...
void menupodanie()
{
    ...
    if((int)w>=49 && (int)w<=56){
        ...
        case '8':
            system ("cls");
            cout<<"Program losuje wspolrzedne trojkata a nastepnie go klasyfikuje."<<endl<<endl;
            zapisilosowanie(a,b,c);     cout<<endl;
            odczytgot(a,b,c);    cout<<endl;
